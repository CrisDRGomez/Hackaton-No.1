...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (form) {
    form.addEventListener('submit', e => {
      ...
      msg.textContent = '✓ Mensaje recibido. Me pongo en contacto pronto.';
  ...
  let clickCount = 0;
  document.querySelectorAll('.nav-mascot, .hero-mascot').forEach(m => {
    m.addEventListener('click', () => {
      ...
      m.style.transition = 'transform .25s cubic-bezier(0.34,1.56,0.64,1)';
      m.style.transform = 'scale(1.35) rotate(15deg)';
